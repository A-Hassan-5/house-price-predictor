# House Price Predictor — Local Deployment (Week 6 Capstone)

A Streamlit web app that loads the best regression model trained in Week 1
...
| `best_house_price_model.pkl` | The trained regression model (Random Forest or Linear Regression, whichever performed best in Week 1) |
...
All four `.pkl` files must be downloaded from the Week 1 Colab notebook and
...
This app is the Week 6 capstone deliverable of the 6-Week Applied Machine
Learning Internship, deploying the best-performing regression model from
Week 1 (Real Estate Regression Analysis — House Price India dataset) as an
